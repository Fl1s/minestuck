...
public final class MSBlockEntityTypes
{
	...
	public static final Supplier<BlockEntityType<ComputerBlockEntity>> COMPUTER = REGISTER.register("computer", () -> BlockEntityType.Builder.of(ComputerBlockEntity::new, MSBlocks.COMPUTER.get(), MSBlocks.OLD_COMPUTER.get()).build(null));
	public static final Supplier<BlockEntityType<LaptopBlockEntity>> LAPTOP = REGISTER.register("laptop", () -> BlockEntityType.Builder.of(LaptopBlockEntity::new, MSBlocks.LAPTOP.get(), MSBlocks.CROCKERTOP.get(), MSBlocks.HUBTOP.get(), MSBlocks.LUNCHTOP.get()).build(null));
