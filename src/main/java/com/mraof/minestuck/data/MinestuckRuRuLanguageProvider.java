...
public class MinestuckRuRuLanguageProvider extends MinestuckLanguageProvider
{
	MinestuckRuRuLanguageProvider(PackOutput output)
	{
		super(output, Minestuck.MOD_ID, "ru_ru");
	}
	...
	protected void addTranslations()
	{
		...
		add("message.shift_for_more_info", "Нажмите §eSHIFT§r для раскрытия подробностей");
		
		addBlock(MSBlocks.STONE_CRUXITE_ORE, "Основитовая руда");
		addBlock(MSBlocks.COBBLESTONE_CRUXITE_ORE, "Основитовая руда");
		addBlock(MSBlocks.SANDSTONE_CRUXITE_ORE, "Основитовая руда");
		addBlock(MSBlocks.RED_SANDSTONE_CRUXITE_ORE, "Основитовая руда");
		addBlock(MSBlocks.NETHERRACK_CRUXITE_ORE, "Основитовая руда");
		addBlock(MSBlocks.END_STONE_CRUXITE_ORE, "Основитовая руда");
		addBlock(MSBlocks.SHADE_STONE_CRUXITE_ORE, "Основитовая руда");
		addBlock(MSBlocks.PINK_STONE_CRUXITE_ORE, "Основитовая руда");
		addBlock(MSBlocks.MYCELIUM_STONE_CRUXITE_ORE, "Основитовая руда");
		addBlock(MSBlocks.UNCARVED_WOOD_CRUXITE_ORE, "Основитовая руда");
		addBlock(MSBlocks.BLACK_STONE_CRUXITE_ORE, "Основитовая руда");
		addBlock(MSBlocks.STONE_URANIUM_ORE, "Урановая руда");
		addBlock(MSBlocks.DEEPSLATE_URANIUM_ORE, "Урановая руда");
		addBlock(MSBlocks.COBBLESTONE_URANIUM_ORE, "Урановая руда");
		addBlock(MSBlocks.SANDSTONE_URANIUM_ORE, "Урановая руда");
		addBlock(MSBlocks.RED_SANDSTONE_URANIUM_ORE, "Урановая руда");
		addBlock(MSBlocks.NETHERRACK_URANIUM_ORE, "Урановая руда");
		addBlock(MSBlocks.END_STONE_URANIUM_ORE, "Урановая руда");
		addBlock(MSBlocks.SHADE_STONE_URANIUM_ORE, "Урановая руда");
		addBlock(MSBlocks.PINK_STONE_URANIUM_ORE, "Урановая руда");
		addBlock(MSBlocks.MYCELIUM_STONE_URANIUM_ORE, "Урановая руда");
		addBlock(MSBlocks.UNCARVED_WOOD_URANIUM_ORE, "Урановая руда");
		addBlock(MSBlocks.BLACK_STONE_URANIUM_ORE, "Урановая руда");
		addBlock(MSBlocks.NETHERRACK_COAL_ORE, "Угольная руда");
		addBlock(MSBlocks.SHADE_STONE_COAL_ORE, "Угольная руда");
		addBlock(MSBlocks.PINK_STONE_COAL_ORE, "Угольная руда");
		addBlock(MSBlocks.SANDSTONE_IRON_ORE, "Железная руда");
		addBlock(MSBlocks.RED_SANDSTONE_IRON_ORE, "Железная руда");
		addBlock(MSBlocks.END_STONE_IRON_ORE, "Железная руда");
		addBlock(MSBlocks.UNCARVED_WOOD_IRON_ORE, "Железная руда");
		addBlock(MSBlocks.SANDSTONE_GOLD_ORE, "Золотая руда");
		addBlock(MSBlocks.RED_SANDSTONE_GOLD_ORE, "Золотая руда");
		addBlock(MSBlocks.SHADE_STONE_GOLD_ORE, "Золотая руда");
		addBlock(MSBlocks.PINK_STONE_GOLD_ORE, "Золотая руда");
		addBlock(MSBlocks.BLACK_STONE_GOLD_ORE, "Золотая руда");
		addBlock(MSBlocks.END_STONE_REDSTONE_ORE, "Редстоуновая руда");
		addBlock(MSBlocks.UNCARVED_WOOD_REDSTONE_ORE, "Редстоуновая руда");
		addBlock(MSBlocks.BLACK_STONE_REDSTONE_ORE, "Редстоуновая руда");
		addBlock(MSBlocks.STONE_QUARTZ_ORE, "Кварцевая руда");
		addBlock(MSBlocks.BLACK_STONE_QUARTZ_ORE, "Кварцевая руда");
		addBlock(MSBlocks.PINK_STONE_LAPIS_ORE, "Лазуритовая руда");
		addBlock(MSBlocks.PINK_STONE_DIAMOND_ORE, "Алмазная руда");
		addBlock(MSBlocks.UNCARVED_WOOD_EMERALD_ORE, "Изумрудная руда");
		
		addBlock(MSBlocks.CRUXITE_BLOCK, "Основитовый блок");
		addBlock(MSBlocks.CRUXITE_STAIRS, "Основитовые ступени");
		addBlock(MSBlocks.CRUXITE_SLAB, "Основитовая плита");
		addBlock(MSBlocks.CRUXITE_WALL, "Основитовая стена");
		addBlock(MSBlocks.CRUXITE_BUTTON, "Основитовая кнопка");
		addBlock(MSBlocks.CRUXITE_PRESSURE_PLATE, "Основитовая нажимная пластина");
		addBlock(MSBlocks.CRUXITE_DOOR, "Основитовая дверь");
		addBlock(MSBlocks.CRUXITE_TRAPDOOR, "Основитовый люк");
		addBlock(MSBlocks.POLISHED_CRUXITE_BLOCK, "Блок из полированного основита");
		addBlock(MSBlocks.POLISHED_CRUXITE_STAIRS, "Ступени из полированного основита");
		addBlock(MSBlocks.POLISHED_CRUXITE_SLAB, "Плита из полированного основита");
		addBlock(MSBlocks.POLISHED_CRUXITE_WALL, "Стена из полированного основита");
		addBlock(MSBlocks.CRUXITE_BRICKS, "Основитовый кирпич");
		addBlock(MSBlocks.CRUXITE_BRICK_STAIRS, "Основитово-кирпичные ступени");
		addBlock(MSBlocks.CRUXITE_BRICK_SLAB, "Основитово-кирпичная плита");
		addBlock(MSBlocks.CRUXITE_BRICK_WALL, "Основитово-кирпичная стена");
		addBlock(MSBlocks.SMOOTH_CRUXITE_BLOCK, "Гладкий основитовый блок");
		addBlock(MSBlocks.CHISELED_CRUXITE_BLOCK, "Резной основитовый блок");
		addBlock(MSBlocks.CRUXITE_PILLAR, "Основитовый столб");
		addBlock(MSBlocks.CRUXITE_LAMP, "Основитовая лампа");
		addBlockTooltip(MSBlocks.CRUXITE_LAMP, "На инструкции есть стрелка, что указывает на правую руку схематичной фигурки. Ты решаешь больше никогда не думать о покупке ламп из ИКЕИ снова.");
		
		addBlock(MSBlocks.URANIUM_BLOCK, "Урановый блок");
		addBlock(MSBlocks.URANIUM_STAIRS, "Урановые ступени");
		addBlock(MSBlocks.URANIUM_SLAB, "Урановая плита");
		addBlock(MSBlocks.URANIUM_WALL, "Урановая стена");
		addBlock(MSBlocks.URANIUM_BUTTON, "Урановая кнопка");
		addBlock(MSBlocks.URANIUM_PRESSURE_PLATE, "Урановая нажимная пластина");
		
		addBlock(MSBlocks.GENERIC_OBJECT, "Абсолютно стандартный объект");
		addBlock(MSBlocks.PERFECTLY_GENERIC_STAIRS, "Абсолютно стандартные ступени");
		addBlock(MSBlocks.PERFECTLY_GENERIC_SLAB, "Абсолютно стандартная плита");
		addBlock(MSBlocks.PERFECTLY_GENERIC_WALL, "Абсолютно стандартная стена");
		addBlock(MSBlocks.PERFECTLY_GENERIC_FENCE, "Абсолютно стандартный забор");
		addBlock(MSBlocks.PERFECTLY_GENERIC_FENCE_GATE, "Абсолютно стандартные ворота");
		addBlock(MSBlocks.PERFECTLY_GENERIC_BUTTON, "Абсолютно стандартная кнопка");
		addBlock(MSBlocks.PERFECTLY_GENERIC_PRESSURE_PLATE, "Абсолютно стандартная нажимная пластина");
		addBlock(MSBlocks.PERFECTLY_GENERIC_DOOR, "Абсолютно стандартная дверь");
		addBlock(MSBlocks.PERFECTLY_GENERIC_TRAPDOOR, "Абсолютно стандартный люк");
		addBlock(MSBlocks.PERFECTLY_GENERIC_SIGN, "Абсолютно стандартная табличка");
		addBlock(MSBlocks.PERFECTLY_GENERIC_HANGING_SIGN, "Абсолютно стандартная подвесная табличка");
		
		addBlock(MSBlocks.METEORIC_STONE, "Метеоритовый камень");
		
		addBlock(MSBlocks.BLUE_DIRT, "Синяя земля");
		addBlock(MSBlocks.THOUGHT_DIRT, "Мысленная земля");
		
		addBlock(MSBlocks.COARSE_STONE, "Грубый камень");
		addBlock(MSBlocks.COARSE_STONE_WALL, "Грубо-каменная стена");
		addBlock(MSBlocks.COARSE_STONE_BUTTON, "Грубо-каменная кнопка");
		addBlock(MSBlocks.COARSE_STONE_PRESSURE_PLATE, "Грубо-каменная нажимная пластина");
		...
		add(ButtonListHelper.CLEAR_BUTTON, "Очистить сообщения");
		add(SburbClientGui.NAME, "СБУРБ клиент");
		add(SburbServerGui.NAME, "СБУРБ сервер");
		add(SburbClientGui.CLOSE_BUTTON, "Отключиться");
		add(SburbServerGui.EDIT_BUTTON, "Режим редакта");
		add(SburbServerGui.GIVE_BUTTON, "Выдать предметы");
		add(SburbServerGui.OPEN_BUTTON, "Открыть сервер");
		add(SburbClientGui.RESUME_BUTTON, "Переподключиться");
		add(SburbClientGui.SELECT_COLOR, "Выбрать цвет");
		add(SburbClientGui.CONNECT, "Подключен к %s");
		add(SburbClientGui.CLIENT_ACTIVE, "Клиент уже в сети");
		add(SburbConnections.CLOSED, "Подключение прервано");
		add(SburbServerGui.OFFLINE, "Сервер вне сети");
		add(SburbClientGui.SELECT, "Выбрать сервер (ниже)");
		add(SburbServerGui.SERVER_ACTIVE, "Сервер с вашим именем уже существует");
		add(SburbClientGui.RESUME_CLIENT, "Ожидаем сервера...");
		add(SburbServerGui.RESUME_SERVER, "Ожидаем клиента...");
		add(DiskBurnerGui.NAME, "Запись дисков");
		add(DiskBurnerGui.NEED_CODE, "Для записи нужен код");
		add(DiskBurnerGui.NO_DISKS, "Вставьте диск для записи");
		add(DiskBurnerGui.BURN_CLIENT_DISK, "Запись клиентского диска");
		add(DiskBurnerGui.BURN_SERVER_DISK, "Запись серверного диска");
		add(DiskBurnerGui.CHOOSE, "Выберите тип диска для записи");
		add(ComputerInteractions.STOP_RESUME, "Ожидание прервано");
		add(SettingsAppGui.NAME, "Настройки");
		add(SettingsAppGui.THEME, "Выберите тему");
		add(SettingsAppGui.DISK_MANAGER, "Диспетчер дисков");
		add(SettingsAppGui.TITLE, "Настройки СБУРБ");
		...
		addThemeName(MSComputerThemes.DEFAULT, "Обычная");
		addThemeName(MSComputerThemes.PESTERCHUM, "ДостаньКореша");
		addThemeName(MSComputerThemes.TROLLIAN, "Троллиан");
		addThemeName(MSComputerThemes.CROCKER, "Крокер");
		addThemeName(MSComputerThemes.TYPHEUS, "Тифус");
		addThemeName(MSComputerThemes.CETUS, "Кето");
		addThemeName(MSComputerThemes.HEPHAESTUS, "Гефест");
		addThemeName(MSComputerThemes.ECHIDNA, "Ехидна");
		addThemeName(MSComputerThemes.JOY, "Счастье");
		addThemeName(MSComputerThemes.SBURB_95, "СБУРБ 95");
		addThemeName(MSComputerThemes.SBURB_10, "СБУРБ 10");
		addThemeName(MSComputerThemes.SCOURGING_HEAT, "Scourging Heat");
		addThemeName(MSComputerThemes.LIFDOFF, "Lifdoff,,");
		addThemeName(MSComputerThemes.SKAIANET_GREEN, "Скайянет зеленый");
		addThemeName(MSComputerThemes.SKAIANET_WHITE, "Скайянет белый");
		addThemeName(MSComputerThemes.SKAIANET_BLACK, "Скайянет черный");
		addThemeName(MSComputerThemes.ASTRAL_CHARTS, "Знаки зодиака");
		addThemeName(MSComputerThemes.TILLDEATH, "~ATH");
		addThemeName(MSComputerThemes.LOWAS, "ЗВИТ");
		addThemeName(MSComputerThemes.SPIROGRAPH, "Спирограф");
