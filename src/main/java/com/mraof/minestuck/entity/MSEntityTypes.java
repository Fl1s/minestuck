...
public final class MSEntityTypes
{
	...
	public static final Supplier<EntityType<MeteorEntity>> METEOR = REGISTER.register("meteor", () -> EntityType.Builder.of(MeteorEntity::new, MobCategory.MISC).sized(10.0F, 10.0F).setTrackingRange(2048).setUpdateInterval(1).build(Minestuck.id("meteor").toString()));
	public static final Supplier<EntityType<MiniMeteorEntity>> MINI_METEOR = REGISTER.register("mini_meteor", () -> EntityType.Builder.of(MiniMeteorEntity::new, MobCategory.MISC).sized(1.2F, 1.2F).setTrackingRange(2048).setUpdateInterval(1).build(Minestuck.id("mini_meteor").toString()));
